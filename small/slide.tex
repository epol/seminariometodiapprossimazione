...
\begin{frame}{Newton's method convergence}
  \begin{myteo}
    ...
    So if $A^{-1/2}X_0$ has no pure imaginary eigenvaules, the $X_k$
...
\begin{frame}{Newton's method convergence}
  ...
  The hypothesis that $A$ has no eigenvaules in $\mathbb{R}^-$ implies
  that the spectrum of $A^{1/2}$ is contained in the open right
  half-plane.
\end{frame}
